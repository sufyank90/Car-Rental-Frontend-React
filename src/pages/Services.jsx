...
// SkeletonLoader component for displaying loading animation
...
function Services() {
  ...
  return (
    ...
    <div class="w-full">
        <div class="mt-32 grid max-w-xs grid-cols-3 gap-1 p-1 mx-auto my-2 bg-gray-100 rounded-lg dark:bg-gray-600" role="group">
      ...
      {loading ? (
        // Display SkeletonLoader while data is loading
        <div className="container mx-auto px-4 md:px-8 lg:px-32 mt-32 mb-5">
        ...
        // Display actual card data
        <div className="container mx-auto px-4 md:px-8 lg:px-32 mb-7 mt-32">
